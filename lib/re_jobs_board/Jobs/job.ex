defmodule Job do
  ...
  def new(), do: %Job{name: pick_words(2) |> make_string, description: pick_words(5) |> make_string, tags: pick_words(3), posted: Faker.Date.between(~D[2000-01-01], ~D[2019-02-22])}
